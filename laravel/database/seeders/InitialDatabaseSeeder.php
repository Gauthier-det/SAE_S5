...
class InitialDatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('SAN_USERS')->insert([
            ...
            ['USE_ID' => 10, 'ADD_ID' => 7, 'CLU_ID' => null, 'USE_MAIL' => 'ino.casablanca@example.com', 'USE_PASSWORD' => 'pwd123', 'USE_NAME' => 'Ino', 'USE_LAST_NAME' => 'Casablanca', 'USE_BIRTHDATE' => '1993-04-30', 'USE_PHONE_NUMBER' => 620000008, 'USE_LICENCE_NUMBER' => 200005, 'USE_PPS_FORM' => null, 'USE_MEMBERSHIP_DATE' => '2023-01-01'],
            ['USE_ID' => 11, 'ADD_ID' => 8, 'CLU_ID' => null, 'USE_MAIL' => 'cassiopee.guerdat@example.com', 'USE_PASSWORD' => 'pwd123', 'USE_NAME' => 'Cassiopée', 'USE_LAST_NAME' => 'Guerdat', 'USE_BIRTHDATE' => '1991-11-20', 'USE_PHONE_NUMBER' => 620000007, 'USE_LICENCE_NUMBER' => 200004, 'USE_PPS_FORM' => null, 'USE_MEMBERSHIP_DATE' => '2023-01-01'],
