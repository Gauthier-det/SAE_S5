...
class InitialDatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('SAN_USERS')->insert([
            ...
            ['USE_ID' => 2, 'ADD_ID' => 2, 'CLU_ID' => null, 'USE_MAIL' => 'marc.marquez@example.com', 'USE_PASSWORD' => $hashedPassword, 'USE_NAME' => 'Marc', 'USE_LAST_NAME' => 'Marquez', 'USE_GENDER' => 'Homme', 'USE_BIRTHDATE' => '1985-05-10', 'USE_PHONE_NUMBER' => 610000002, 'USE_LICENCE_NUMBER' => 100002, 'USE_MEMBERSHIP_DATE' => '2021-01-01', 'USE_VALIDITY' => '2024-11-12'],
            ['USE_ID' => 3, 'ADD_ID' => 3, 'CLU_ID' => null, 'USE_MAIL' => 'fabio.quartararo@example.com', 'USE_PASSWORD' => $hashedPassword, 'USE_NAME' => 'Fabio', 'USE_LAST_NAME' => 'Quartararo', 'USE_GENDER' => 'Homme', 'USE_BIRTHDATE' => '1978-03-15', 'USE_PHONE_NUMBER' => 610000003, 'USE_LICENCE_NUMBER' => 100003, 'USE_MEMBERSHIP_DATE' => '2021-01-01', 'USE_VALIDITY' => '2023-01-13'],
            ['USE_ID' => 4, 'ADD_ID' => 2, 'CLU_ID' => null, 'USE_MAIL' => 'loane.kante@example.com', 'USE_PASSWORD' => $hashedPassword, 'USE_NAME' => 'Loane', 'USE_LAST_NAME' => 'Kante', 'USE_GENDER' => 'Femme', 'USE_BIRTHDATE' => '2000-05-10', 'USE_PHONE_NUMBER' => 610000004, 'USE_LICENCE_NUMBER' => 100006, 'USE_MEMBERSHIP_DATE' => '2023-01-01', 'USE_VALIDITY' => '2024-06-30'],
            ['USE_ID' => 5, 'ADD_ID' => 3, 'CLU_ID' => null, 'USE_MAIL' => 'jack.sparrow@example.com', 'USE_PASSWORD' => $hashedPassword, 'USE_NAME' => 'Jack', 'USE_LAST_NAME' => 'Sparrow', 'USE_GENDER' => 'Homme', 'USE_BIRTHDATE' => '1978-03-15', 'USE_PHONE_NUMBER' => 610000005, 'USE_LICENCE_NUMBER' => 100007, 'USE_MEMBERSHIP_DATE' => '2021-01-01', 'USE_VALIDITY' => '2022-06-07'],
            ['USE_ID' => 6, 'ADD_ID' => 3, 'CLU_ID' => null, 'USE_MAIL' => 'danielle.june.marsh@example.com', 'USE_PASSWORD' => $hashedPassword, 'USE_NAME' => 'Danielle', 'USE_LAST_NAME' => 'Marsh', 'USE_GENDER' => 'Femme', 'USE_BIRTHDATE' => '2005-03-11', 'USE_PHONE_NUMBER' => 610000006, 'USE_LICENCE_NUMBER' => 100008, 'USE_MEMBERSHIP_DATE' => '2021-01-01', 'USE_VALIDITY' => '2024-12-31'],
            ['USE_ID' => 7, 'ADD_ID' => 4, 'CLU_ID' => null, 'USE_MAIL' => 'alice.durand@example.com', 'USE_PASSWORD' => $hashedPassword, 'USE_NAME' => 'Alice', 'USE_LAST_NAME' => 'Durand', 'USE_GENDER' => 'Femme', 'USE_BIRTHDATE' => '1990-06-01', 'USE_PHONE_NUMBER' => 620000004, 'USE_LICENCE_NUMBER' => 200001, 'USE_MEMBERSHIP_DATE' => '2023-01-01', 'USE_VALIDITY' => '2023-02-16'],
            ...
            ['USE_ID' => 9, 'ADD_ID' => 6, 'CLU_ID' => null, 'USE_MAIL' => 'hugo.dialo@example.com', 'USE_PASSWORD' => $hashedPassword, 'USE_NAME' => 'Hugo', 'USE_LAST_NAME' => 'Dialo', 'USE_GENDER' => 'Homme', 'USE_BIRTHDATE' => '1995-09-15', 'USE_PHONE_NUMBER' => 620000006, 'USE_LICENCE_NUMBER' => 200003, 'USE_MEMBERSHIP_DATE' => '2023-01-01', 'USE_VALIDITY' => '2023-03-09'],
            ['USE_ID' => 10, 'ADD_ID' => 7, 'CLU_ID' => null, 'USE_MAIL' => 'ino.casablanca@example.com', 'USE_PASSWORD' => $hashedPassword, 'USE_NAME' => 'Ino', 'USE_LAST_NAME' => 'Casablanca', 'USE_GENDER' => 'Homme', 'USE_BIRTHDATE' => '1993-04-30', 'USE_PHONE_NUMBER' => 620000008, 'USE_LICENCE_NUMBER' => 200005, 'USE_MEMBERSHIP_DATE' => '2023-01-01', 'USE_VALIDITY' => '2024-07-18'],
            ['USE_ID' => 11, 'ADD_ID' => 8, 'CLU_ID' => null, 'USE_MAIL' => 'cassiopee.guerdat@example.com', 'USE_PASSWORD' => $hashedPassword, 'USE_NAME' => 'Cassiopée', 'USE_LAST_NAME' => 'Guerdat', 'USE_GENDER' => 'Autre', 'USE_BIRTHDATE' => '1991-11-20', 'USE_PHONE_NUMBER' => 620000007, 'USE_LICENCE_NUMBER' => 200004, 'USE_MEMBERSHIP_DATE' => '2023-01-01', 'USE_VALIDITY' => '2024-08-31'],
            ['USE_ID' => 12, 'ADD_ID' => 9, 'CLU_ID' => null, 'USE_MAIL' => 'coureur.sansclub@example.com', 'USE_PASSWORD' => $hashedPassword, 'USE_NAME' => 'Chloe', 'USE_LAST_NAME' => 'Libre', 'USE_GENDER' => 'Femme', 'USE_BIRTHDATE' => '1998-01-10', 'USE_PHONE_NUMBER' => 620000009, 'USE_LICENCE_NUMBER' => null, 'USE_MEMBERSHIP_DATE' => '2024-01-01', 'USE_VALIDITY' => null],
        ]);
