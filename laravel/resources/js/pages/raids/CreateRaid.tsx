...
const CreateRaid = () => {
    ...
    const handleSelectChange = (e: any) => {
        setFormData((prev) => ({
            ...prev,
            CLU_ID: parseInt(e.target.value as string, 10)
        }));
    }
                ...
                <Box component="form" onSubmit={handleSubmit} sx={{ width: '100%' }}>
                    ...
                    <FormControl fullWidth variant="standard" margin="normal">
                        ...
                        <Select
                            ...
                            displayEmpty
                        >
                            <MenuItem value={0} disabled>Choisir un organisateur</MenuItem>
                            <MenuItem value={1}>Club 1</MenuItem>
                            <MenuItem value={2}>Club 2</MenuItem>
                        </Select>
                    </FormControl>
